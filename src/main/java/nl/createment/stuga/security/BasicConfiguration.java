...
public class BasicConfiguration extends WebSecurityConfigurerAdapter {
	...
	private static String[] whitelistedURIs = {
			"/login",
			"/register", 
			"/css/styleLoginRegister.css",
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(whitelistedURIs).permitAll()
		.antMatchers("/delete-channel").hasAuthority("ADMIN")
